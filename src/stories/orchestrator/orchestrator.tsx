...
export const OrchestratorForStories = (props: OrchestratorProps) => {
  ...
  const { source, data, management, activeControls, features, initialPage, getStoreInfo, missing, shortcut, activeGoNextForMissing, suggesterFetcher,
    autoSuggesterLoading, suggesters, preferences, savingType, custom, filterDescription } = props;
